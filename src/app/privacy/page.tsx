    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="prose prose-lg prose-slate max-w-none text-slate-600 space-y-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-6 border-b border-slate-200 pb-4">1. Informasi yang Kami Kumpulkan</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-6 border-b border-slate-200 pb-4">2. Penggunaan Informasi</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-6 border-b border-slate-200 pb-4">3. Keamanan Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-6 border-b border-slate-200 pb-4">4. Hubungi Kami</h2>
          <p>
